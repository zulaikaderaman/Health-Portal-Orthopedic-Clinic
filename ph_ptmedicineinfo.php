...
if (isset($_POST['submitted'])) {
    ...
    $med_scientificname = $_POST['med_scientificname'];
    $med_instruction = $_POST['med_instruction'];


    $query = "INSERT INTO medicine( med_name,med_scientificname,med_instruction,screeningid) VALUES('$_POST[med_name]','$_POST[med_scientificname]','$_POST[med_instruction]', $screeningid)";
                        ...
                        <div class="col-xs-12 col-md-4">
                            <div class="form-group">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><input type="text" size="50" placeholder="" name="med_name" required></td>
                                </tr>
                                <br>
                                <br>
                                <tr>
                                    <td style="width:20%">Scientific Name: </td>
                                    <td colspan="2"><input type="text" size="100" placeholder="" name="med_scientificname" required></td>
                                </tr>
                                <br>
                                <br>
                                <tr>
                                    <td style="width:20%">Instruction: </td>
                                    <td colspan="2"><input type="text" size="100" placeholder="" name="med_instruction" required></td>
                                </tr>
                                <br>
                                <br>


                                <div><button type="submit" class="btn btn-info" name="submitted">Submit Medicine</button></div>
