...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
    ...
    <form id='login' action='loginadmin2.php' method="post" accept-charset='UTF-8'>
        <fieldset >
            <center><h2>WELCOME DEAR ADMIN!</h2></center>
            <input type='hidden' name='submitted' id='submitted' value='1'/>
            <center><label for='username' >UserName*:</label>
                <input type='text' name='admin_username' id='admin_username'  maxlength="50" /></center>
            <br>
            <center><label for='password' >Password*:</label>
                <input type='password' name='admin_password' id='admin_password' maxlength="50" /></center>
            <br>
