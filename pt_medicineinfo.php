...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
    ...
    <div class="main">
        ...
        $query = "SELECT * FROM medicine INNER JOIN screening ON medicine.screeningid = screening.screeningid WHERE screeningid='".$_GET['id']."'";
        ...
        while($row = mysqli_fetch_array($result)) {
            ...
            <br>
            <br>
            Medicine Name: <?php echo '<td>'.$row['med_name'].'</td>';?>
            <br>
            <br>
            Scientific Name: <?php echo '<td>'.$row['med_scientificname'].'</td>';?>
            <br>
            <br>
            Instruction: <?php echo '<td>'.$row['med_instruction'].'</td>';?>
