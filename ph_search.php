    ...
    <div class="main">
        ...
        <form method="post" action="">
            ...
            while($row= mysqli_fetch_array($result)){
             ...
             <td>'.$row['pt_name'].'</td>
             <td>'.$row['pt_ic'].'</td>
             <td><a class="btn btn-success btn-sm" href="ph_ptscreening.php?id='.$row["patientid"].'"><i class="fa fa-file"> Health Screening</i></a>
				<br>
				<a class="btn btn-success btn-sm" href="ph_ptmedicalrecord.php?id='.$row["patientid"].'"><i class="fa fa-edit"> Medical Record</i></a>
				<br>
				<a class="btn btn-success btn-sm" href="ph_ptmedicine.php?id='.$row["patientid"].'"><i class="fa fa-medkit"> Medicine</i></a>
			</td>
             </tr>';
