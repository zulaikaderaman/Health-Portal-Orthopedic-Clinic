...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
    ...
    <div class="main">
        ...
        <div class="w3-row-padding w3-margin-bottom">
            <div class="w3-half"><a href="ph_profile.php">
                    <div class="w3-container w3-pink w3-padding-16">
                        <div class="w3-clear"></div>
                        <div class="w3-left"></div>
                        <h4><i class="fa fa-user-circle-o w3-xxlarge"><br>Physician Profile</i></h4>
                    </div>
            </div>

            <div class="w3-half"><a href="ph_search.php">
                    <div class="w3-container w3-purple w3-padding-16">
                        <div class="w3-clear"></div>
                        <div class="w3-left"></div>
                        <h4><i class="fa fa-search w3-xxlarge"><br>Search Patient</i></h4>
                    </div>
            </div>
