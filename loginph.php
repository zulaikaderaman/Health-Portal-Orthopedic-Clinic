...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
    ...
    <form id='login' action='loginph2.php' method='post' accept-charset='UTF-8'>
        <fieldset >
            <center><h2>WELCOME DEAR PHYSICIAN!</h2></center>
            <input type='hidden' name='submitted' id='submitted' value='1'/>
            <center><label for='ph_personalcode' >Personal Code*:</label>
                <input type='text' name='ph_personalcode' id='ph_personalcode' maxlength="50" /></center>
            <br>
            <center><label for='ph_password' >Password*:</label>
                <input type='password' name='ph_password' id='ph_password' maxlength="50" /></center>
            <br>
