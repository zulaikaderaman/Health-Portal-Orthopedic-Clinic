...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
    ...
    <form id='login' action='loginpt2.php' method='post' accept-charset='UTF-8'>
        <fieldset >
            <center><h2>WELCOME DEAR PATIENT!</h2></center>
            <input type='hidden' name='submitted' id='submitted' value='1'/>
            <center><label for='pt_ic' >IC Number*:</label>
                <input type='text' name='pt_ic' id='pt_ic' maxlength="50" /></center>
            <br>
            <center><label for='pt_password' >Password*:</label>
                <input type='password' name='pt_password' id='pt_password' maxlength="50" /></center>
            <br>
